  ...
  <Box>
    <Flex flexWrap="wrap">
      ...
      <Box width={[1, 1 / 2]}>
        <Box mt={[3, 0]}>
          <Description as="h2">
            Lorem ipsum dolor amet scenester
            distillery tbh messenger bag DIY pok
            pok food truck. Ramps iPhone gastropub
            actually freegan cardigan.
          </Description>
        </Box>
      </Box>
    </Flex>
